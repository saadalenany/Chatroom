...
public class ChatSocket {
    ...
    public static void connect() {
        try {
            ...
            // on machine 'localhost' port 7003.
            System.out.println("Connection to localhost:7003....");
            Socket socketOfClient = new Socket(Protocols.ServerAddress, Protocols.ChatPort);
